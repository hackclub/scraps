export default {
	...
	lootbox: {
		...
		createLootbox: 'crear caja de botín',
		editLootbox: 'editar caja de botín',
		items: 'artículos',
		percentage: '% de probabilidad',
		autoFill: 'auto-rellenar',
		mustSumTo100: 'los porcentajes deben sumar 100',
		selectBoostItem: 'selecciona un artículo para potenciar',
		boostHint: 'selecciona un artículo para duplicar su probabilidad',
		openLootbox: 'abrir caja de botín',
		confirmOpen: 'confirmar apertura de caja',
		confirmOpenMessage: '¿estás seguro de que quieres abrir esta caja? costará',
		youWon: 'ganaste',
		badge: 'caja de botín',
		selectItems: 'seleccionar artículos',
		noItemsSelected: 'no hay artículos seleccionados',
		atLeast2Items: 'se requieren al menos 2 artículos',
		totalPercentage: 'total',
		boosted: 'potenciado',
		outOfStock: 'agotado',
		rolling: 'abriendo...',
		containsItems: 'contiene {count} artículos',
		yourBoostedChance: 'tu probabilidad potenciada',
		noBoostedItem: 'selecciona un artículo para potenciar primero',
		allItemsOutOfStock: 'todos los artículos están agotados',
		price: 'precio'
	},
	about: {
