export default {
	...
	createProject: {
		...
		isUpdateLabel: 'this is a reship of a previously shipped project',
		whatDidYouUpdate: 'what did you change since the last ship?',
		updateDescriptionPlaceholder: 'Describe what you changed or improved since the last ship...',
		pleaseDescribeUpdate: 'Please describe what you changed',
	...
	address: {
		...
		selectedAddress: 'selected address (edit if anything needs fixing):',
	...
	admin: {
		...
		manageAllProjects: 'browse every project on scraps',
