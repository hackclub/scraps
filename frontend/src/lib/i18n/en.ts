export default {
	...
	lootbox: {
		lootbox: 'lootbox',
		createLootbox: 'create lootbox',
		editLootbox: 'edit lootbox',
		items: 'items',
		percentage: 'chance %',
		autoFill: 'auto-fill',
		mustSumTo100: 'percentages must sum to 100',
		selectBoostItem: 'select an item to boost',
		boostHint: 'select one item to double its chance',
		openLootbox: 'open lootbox',
		confirmOpen: 'confirm open lootbox',
		confirmOpenMessage: 'are you sure you want to open this lootbox? this will cost',
		youWon: 'you won',
		badge: 'lootbox',
		...
		yourBoostedChance: 'your boosted chance',
		noBoostedItem: 'select an item to boost first',
		allItemsOutOfStock: 'all items are out of stock',
		price: 'price'
	},
	about: {
